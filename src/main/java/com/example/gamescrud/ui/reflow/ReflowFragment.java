...
public class ReflowFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if(getArguments() == null){
            ...
            try {
                fc.getImage(game2.getImagePath()).getDownloadUrl().addOnSuccessListener(uri -> Glide
                        .with(this)
                        .load(uri.toString())
...
//        reflowViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
    ...
    public void onUpdate(View v){
        ...
        if(getArguments() !=null){
            ...
            this.gameContract.updateGame(game2, imageUri, objects -> {
                ...
                Snackbar.make(v, "Game updated", Snackbar.LENGTH_LONG).show();
            });
            ...
            this.gameContract.createGame(game2, imageUri, objects -> {
                ...
                Snackbar.make(v, "Game created", Snackbar.LENGTH_LONG).show();
            });
        }
    }
    ...
    public void onDelete(View v) {
        ...
        this.gameContract.deleteGame(getArguments().getString("id"), unused -> {
            Navigation.findNavController(v).popBackStack();
            Snackbar.make(v, "Game deleted", Snackbar.LENGTH_LONG).show();
        });
    }
